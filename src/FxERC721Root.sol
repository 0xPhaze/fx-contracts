...
bytes4 constant REGISTER_ERC721_IDS_SIG = bytes4(keccak256("registerERC721IdsWithChild(address,uint256[])"));
bytes4 constant DEREGISTER_ERC721_IDS_SIG = bytes4(keccak256("deregisterERC721IdsWithChild(uint256[])"));
...
abstract contract FxERC721Root is FxBaseRootTunnel {
    ...
    function _registerERC721IdsWithChild(address to, uint256[] calldata ids) internal virtual {
        _sendMessageToChild(abi.encodeWithSelector(REGISTER_ERC721_IDS_SIG, to, ids));
    }
